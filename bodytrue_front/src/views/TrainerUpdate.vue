    ...
    <div>
      <div class="join_main">
        <div class="join_wrap">
          ...
          <div class="join_list">
            <form @submit.prevent="updateTrainerInfo">
              <div class="form_group">
                <div class="form_left">
                  <span>&nbsp;&nbsp;&nbsp;이메일</span>
                </div>
                <div class="form_right">&nbsp;&nbsp;
                  <input type="email" id="email1" v-model="trData.tr_email" disabled>
                </div>
              </div>
              <div class="form_group">
                <div class="form_left">
                ...
                <div class="form_right">&nbsp;&nbsp;
                  <input type="password" id="password1" v-model="trData.tr_pwd" name="password1">
              ...
              <div class="form_group">
                          ...
                          <div class="form_right">&nbsp;&nbsp;
                              <input type="text" id="trname" v-model="trData.tr_name" name="trname" disabled>
                          </div>                        
                      </div>   
                      <div class="form_group">
                          <div class="form_left">
                          ...
                          <div class="form_right">&nbsp;&nbsp;
                              <label for="tr">
                                  <input type="radio" id="tr" v-model="tr_auth" name="auth" value="1"  disabled> 회원 &nbsp;&nbsp;
                              </label>
                              <label for="trainer">
                                  <input type="radio" id="trainer" v-model="tr_auth" name="auth" value="2" checked disabled> 트레이너
                              </label>
                          </div>                        
                      </div>     
                      <div class="form_group">
                          ...
                          <div class="form_right">&nbsp;&nbsp;
                              <label for="men">
                                  <input type="radio" id="men" v-model="trData.tr_sex" name="sex" value="M" disabled > 남자 &nbsp;&nbsp;
                              </label>
                              <label for="women">
                                  <input type="radio" id="women" v-model="trData.tr_sex" name="sex" value="F" disabled > 여자
                              </label>
                          </div>                        
                      </div>            
              <div class="form_group">
                          ...
                          <div class="form_right">
                              <div class="address_group">
                                  <div class="address_row">&nbsp;&nbsp;
                                      <input type="text" id="postcode" name="postcode" v-model="trData.tr_addno" placeholder="우편번호" required>
                                      <button type="button" class="address_search" @click="zipload">주소 검색</button>
                                  </div>
                                  <div class="address_row">&nbsp;&nbsp;
                                      <input type="text" id="address" name="address" v-model="trData.tr_add1" placeholder="기본 주소">
                                  </div>
                                  <div class="address_row">&nbsp;&nbsp;
                                      <input type="text" id="address_detail" name="address_detail" v-model="trData.tr_add2" placeholder="상세 주소">
                                  </div>
                              </div>
                          </div>
                      ...
                      <div class="form_group">
                        ...
                        <div class="form_right">&nbsp;&nbsp;
                          <select name="number1" v-model="trData.tr_tel1" id="number1">
                            <option value="010">010</option>
                            <option value="011">011</option>
                            <option value="012">012</option>
                          </select>
                          <span> - </span>
                          <input type="text" name="number2" v-model="trData.tr_tel2" id="number2">
                          <span> - </span>
                          <input type="text" name="number3" v-model="trData.tr_tel3" id="number3">
                        </div>
                      </div>
        ...
        if (!this.trData.tr_tel2 || !this.trData.tr_tel3) {
          ...
          return false;
            ...
            async myinfo(){
              ...
              axios.post(`http://localhost:3000/trainer/trainerupdate/${tr_no}`)
              .then(response => {
                  this.trData = response.data[0];
                  this.trData.tr_sex = response.data[0].tr_sex; // 성별 정보 설정
              })
              .catch(error => {
          ...
          zipload() {
              ...
              new window.daum.Postcode({
                  oncomplete: (data) => {
                      ...
                      if (data.trSelectedType === 'R') { // 사용자가 도로명 주소를 선택했을 경우
                          addr = data.roadAddress;
                      } else { // 사용자가 지번 주소를 선택했을 경우(J)
                          addr = data.jibunAddress;
                      }
                      // 사용자가 선택한 주소가 도로명 타입일때 참고항목을 조합한다.
                      if (data.trSelectedType === 'R') {
                      ...
                      this.trData.tr_addno = data.zonecode;
                      this.trData.tr_add1 = addr;
                      this.trData.tr_addn2 = extraAddr;
                  }
              }).open();
          },
          //회원 정보 수정
          ...mapMutations(['settr']),
          async updatetr(tr_no) {
            if (!this.validateForm()) {
                  return;
              }
            const tr_tel = this.trData.tr_tel1 + '-' + this.trData.tr_tel2 + '-' + this.trData.tr_tel3;
        const tr = {
          tr_no: tr_no,
          tr_addno: this.trData.tr_addno,
          tr_add1: this.trData.tr_add1,
          tr_add2:this.trData.tr_add2,
          tr_pwd: this.trData.tr_pwd,
          tr_tel: tr_tel,
        };
        try {
